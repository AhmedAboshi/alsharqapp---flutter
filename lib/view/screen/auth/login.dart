...
import 'package:alsharqapp/Controller/auth/login_controller.dart';
          ...
          child: GetBuilder<LoginControllerImp>(
            builder: (controller) =>
               HandlingDataRequest( statusRequest:controller.statusRequest, widget: Container(
                        ...
                        //     Text(" Welcom ${controller.myServices.sharedPreferences.getString("username")}"),
                            const LogoAuth(),

                            const SizedBox(height: 20),
                            CustomTextTitleAuth(text: "10".tr),
                            const SizedBox(height: 10),
                            CustomButtomAuth(text: "11".tr),
                            ...
                            GetBuilder<LoginControllerImp>(
                              builder: (controller) => CustonTextFormAutht(
